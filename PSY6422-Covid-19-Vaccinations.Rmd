...
```{r create plot, warning=FALSE, eval=TRUE, message=FALSE, echo=TRUE, results='markup', fig.height=6, fig.width=10}
...
```{r adding plotly, warning=FALSE, eval=TRUE, message=FALSE, echo=TRUE, results='markup', fig.height=6, fig.width=10}
